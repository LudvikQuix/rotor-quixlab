...
@canvas.notebook(position=(2342, -6259), size=(560, 420), code_height=200, viz={'cells': {'3': {'type': 'table', 'x': 'source', 'y': 'rows'}, '4': {'type': 'table', 'x': 'source', 'y': 'rows'}, '5': {'type': 'bar', 'x': 'amplitude_range', 'y': ['good_neutral_shaft_count', 'bad_shaft_count']}}, 'outputCells': [2, 3], 'type': 'scatter', 'x': 'idx', 'y': ['good_neutral', 'bad']})
