...
@canvas.notebook(position=(1705, -6725), size=(1461, 1544), code_height=200, viz={'cells': {'3': {'type': 'table', 'x': 'source', 'y': 'rows'}, '4': {'type': 'line', 'x': 'source', 'y': 'rows'}, '5': {'type': 'bar', 'x': 'good_neutral_shaft_count', 'y': 'bad_shaft_count'}, '6': {'codeHidden': [5], 'type': 'waveform', 'x': 'amplitude_range', 'y': ['good_shaft_count', 'neutral_shaft_count', 'bad_shaft_count']}}, 'hideCode': True, 'outputCells': [3, 4, 6], 'type': 'scatter', 'x': 'idx', 'y': ['good_neutral', 'bad']})
